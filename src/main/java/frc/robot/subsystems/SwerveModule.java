...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    m_turningMotor.configForwardSoftLimitEnable(true);
    m_turningMotor.configForwardSoftLimitThreshold(4096/2*8/3);
    m_turningMotor.configReverseSoftLimitEnable(true);
    m_turningMotor.configReverseSoftLimitThreshold(-4096/2*8/3);
